...
const Header: React.FC = () => {
  ...
  const NavItems = () => (
    <>
      ...
      <li>
        <Link to="/test" className="flex items-center text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition duration-300">
      ...
      {user && (
        <>
          ...
          <li><Link to="/build" className="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition duration-300">Resume Builder</Link></li>
